...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
		   ['Darnell'],
		   ['AlchoholicDJ',      'DJ_Icon',       'Animator',  'https://mobile.twitter.com/AlchoholicDj', '0xFF001698'],
		   ['BrightFyre',       'brrfrr',       'Programming',  'https://mobile.twitter.com/fyre_bright', '0xFFb60041'],
		   ['Teeth',        'Teeth',        'BG artist',  'https://twitter.com/teethlust', '0xFF982a3e'],
		   ['PhantomArcade',        'phantomarcade',       'Original Sprites/Animation',  'https://twitter.com/PhantomArcade3K', '0xFFffcc1b'],
		   ['KawaiSprite',       'kawaisprite',       'Music',  'https://twitter.com/kawaisprite', '0xFF6475f3'],
		   [''],
		   ['Darnell Android Port'],
		   ['Sasko',      'sasko',       'Porter',       'https://m.youtube.com/channel/UC8U5WwaobWOJJpKEKbPPdQA','0xFFE01F32'],
